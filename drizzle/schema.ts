...
export const journalEntries = mysqlTable('journal_entries', {
  ...
  result: mysqlEnum('result', ['RUNNING', 'WINNER', 'STOPPED', 'FAILED', 'BREAKEVEN', 'PENDING']).default('PENDING'),
  directionCorrect: mysqlEnum('direction_correct', ['YES', 'NO', 'PENDING', 'N/A']).default('PENDING'),
  entryQuality: mysqlEnum('entry_quality', ['GOOD', 'EARLY', 'LATE', 'N/A', 'PENDING']).default('PENDING'),
